    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-start">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          <div
            className={`flex flex-col gap-5 w-full  font-semibold mb-2 min-[480px]:text-md md:text-2xl lg:text-3xl`}>
            <h3
              className={`flex flex-col gap-5 w-full text-[#D6482B] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl`}>
              WOWBids Payment Details
            </h3>
            <hr />

            <p
              className={`flex flex-col gap-5 w-full text-stone-500 font-semibold mb-2 min-[480px]:text-sm md:text-md lg:text-xl`}>
              Bank Name: ABC bank
              <br /> Bank Account Number: 123456789012345
              <br />
              Bank Account Holder Name: Abc Abc
              <br />
              IFSC: ABC0001234
              <br />
              UPI ID: abcabc@abc
